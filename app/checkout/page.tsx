        ...
        <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center p-8">
          <div className="max-w-lg w-full text-center">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/bookings"
                className="flex-1 py-3 bg-foreground text-background rounded-xl font-semibold hover:bg-foreground/90 transition-colors"
              >
                View Bookings
              </Link>
              <Link
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <div key={s.num} className="flex items-center">
                  ...
                  {i < 2 && <div className={cn("w-12 h-0.5 mx-4", step > s.num ? "bg-emerald-500" : "bg-muted")} />}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              {step === 2 && (
                <div className="bg-card rounded-2xl border border-border p-6 space-y-6">
                  <div>
                    <h2 className="text-xl font-bold text-foreground mb-1">Guest Information</h2>
                    <p className="text-muted-foreground text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className="w-12 h-12 rounded-xl border border-border flex items-center justify-center hover:bg-muted transition-colors text-lg font-semibold"
                      >
                        -
                      </button>
                      <div className="w-20 text-center">
                        <span className="text-3xl font-bold text-foreground">{formData.guests}</span>
                      </div>
                      <button
                        onClick={() =>
                      ...
                      <span className="text-sm text-muted-foreground">Max {pkg.availability} available</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-primary text-white rounded-xl font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Continue to Payment
                    </button>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="bg-card rounded-2xl border border-border p-6 space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Select how you'd like to process this booking</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <button
                        ...
                        className={cn(
                          "flex flex-col items-start gap-3 p-5 rounded-xl border-2 transition-all text-left",
                      ...
                      >
                        ...
                        <div>
                          <p className="font-semibold text-foreground">Invoice Payment</p>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Process payment immediately via card.</p>
                        </div>
                        {formData.paymentMethod === "card" && (
                          <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center ml-auto">
                            <Check className="h-3 w-3 text-white" />
                    ...
                    {formData.paymentMethod === "invoice" && (
                      <div>
                        <label className="block text-sm font-medium text-foreground mb-2">PO Number (Optional)</label>
                        <input
                          type="text"
              ...
              <div className="sticky top-24 bg-card rounded-2xl border border-border overflow-hidden">
                ...
                <div className="relative aspect-video">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-white font-bold">{pkg.circuit}</p>
