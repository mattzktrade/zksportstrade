...
const faqs = [
    ...
    questions: [
      {
        ...
        a: "Browse packages by race, open a package, choose guest numbers, and complete checkout with your client details. You will receive a confirmation email; we then invoice your client from Xero (no card payment in this portal).",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "What prices do I see in the portal?",
        a: "All package prices shown are your trade rates — we do not display retail pricing or commission splits in the portal.",
      },
      {
        q: "How does payment work?",
        a: "We do not take card payments through the portal. After you submit a booking, our team issues an invoice from Xero to your client. Payment terms (due date, currency, etc.) are stated on that invoice.",
      },
      {
        q: "Where can I see invoice status?",
        a: "Use the Invoices section for a summary. Detailed payment status will align with Xero as we connect that workflow in a later release.",
      },
    ],
  },
  {
