  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Each booking shows a payment status: Awaiting payment (invoice sent, payment outstanding) or Paid. Wix website orders are paid at checkout. Use the payment filter on My Bookings.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Open My Bookings and use the payment status filter. Each row shows Awaiting payment or Paid for that booking reference.",
      },
      {
