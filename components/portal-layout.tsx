...
import { LayoutDashboard, Ticket, CalendarCheck, FileText, HelpCircle, LogOut, Menu } from "lucide-react"
        ...
        <div className="p-3 border-t border-border">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground truncate">{currentAgent.company}</p>
            </div>
          </Link>
